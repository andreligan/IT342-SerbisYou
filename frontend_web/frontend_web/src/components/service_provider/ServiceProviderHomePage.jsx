      ...
      <div className="bg-white p-6 rounded-lg shadow-lg mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <Link
            ...
            className="flex items-center gap-2 p-4 hover:bg-[#F4CE14]/10 transition-colors rounded-lg"
          >
            <div className="h-10 w-10 bg-[#495E57]/10 rounded-full flex items-center justify-center">
              <svg className="w-5 h-5 text-[#495E57]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01" />
              </svg>
            </div>
            <div className="flex-1">
              <p className="font-medium text-gray-900">Customer Bookings</p>
              <p className="text-sm text-gray-500">Manage service requests and appointments</p>
            </div>
